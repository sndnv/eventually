...
object DateTimeExtensions {
    ...
    fun CharSequence.parseAsFullDateTime(context: Context): Instant =
        LocalDateTime.parse(this, dateTimeFormatter(context)).atZone(ZoneId.systemDefault()).toInstant()
    ...
    private fun dateOnlyFormatter(context: Context): DateTimeFormatter =
        dateOnlyFormatter(PreferenceManager.getDefaultSharedPreferences(context).getDateTimeFormat())

    private fun timeOnlyFormatter(context: Context): DateTimeFormatter =
        timeOnlyFormatter(PreferenceManager.getDefaultSharedPreferences(context).getDateTimeFormat())

    private fun dateTimeFormatter(context: Context): DateTimeFormatter =
        dateTimeFormatter(PreferenceManager.getDefaultSharedPreferences(context).getDateTimeFormat())
